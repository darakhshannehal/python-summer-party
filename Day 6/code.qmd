...
monthly_sales_df = ice_cream_sales_data.groupby('sale_month', as_index=False)['sales_volume'].sum()
...
```{python}
# Extra: If you want to visualize these outliers, a boxplot grouped by month would be a great next step to confirm your findings visually.
